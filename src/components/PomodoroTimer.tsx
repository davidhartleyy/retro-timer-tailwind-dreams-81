...
const Timer: React.FC<TimerProps> = () => {
  ...
  return <div className="min-h-screen flex" style={{
    backgroundColor: '#1a1a1a'
      ...
      <audio ref={audioRef} src="https://www.soundjay.com/misc/sounds/bell-ringing-05.wav" preload="auto" />
        ...
        <div className="text-center">
          ...
          <div className="mb-12 flex flex-col items-center">
            <div className="w-64 h-2 bg-gray-700 rounded-full mb-4 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-amber-500 to-orange-500 rounded-full transition-all duration-1000 ease-out" style={{
          ...
          <div className="flex items-center justify-center gap-6">
            <Button onClick={toggleTimer} className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white border-none shadow-xl rounded-full px-10 py-4 text-lg font-semibold transition-all duration-200 transform hover:scale-105">
              {isActive ? <Pause className="w-6 h-6 mr-3" /> : <Play className="w-6 h-6 mr-3" />}
              {isActive ? 'Pause' : 'Start'}
            </Button>
            
            <Button onClick={resetTimer} variant="ghost" className="text-gray-400 hover:text-white hover:bg-gray-800 rounded-full px-8 py-4 text-lg font-semibold transition-all duration-200">
